...
('Executive Suite', 'Suite', 1250000, N'Trống', N'Khu vực tiếp khách riêng biệt với cửa sổ kính suốt từ trần đến sàn và phòng tắm lát đá cẩm thạch.', GETUTCDATE(), GETUTCDATE()),

('Penthouse Sky', 'Penthouse', 2750000, N'Trống', N'Đỉnh cao của sự sang trọng với hồ bơi riêng và tầm nhìn toàn cảnh đường chân trời.', GETUTCDATE(), GETUTCDATE()),
...
('Family Grand Suite', 'Suite', 1500000, N'Trống', N'Cấu hình nhiều phòng lý tưởng cho các gia đình tìm kiếm sự sang trọng và riêng tư.', GETUTCDATE(), GETUTCDATE()),
...
('Premium Deluxe', 'Deluxe', 800000, N'Trống', N'Nội thất cao cấp, không gian mở với ánh sáng tự nhiên và bồn tắm thư giãn.', GETUTCDATE(), GETUTCDATE()),

('Royal Suite', 'Suite', 1900000, N'Trống', N'Trải nghiệm hoàng gia với dịch vụ quản gia riêng và phòng ăn sang trọng.', GETUTCDATE(), GETUTCDATE()),

('Cozy Standard', 'Standard', 320000, N'Trống', N'Không gian ấm cúng, yên tĩnh, hoàn hảo cho những chuyến công tác ngắn ngày.', GETUTCDATE(), GETUTCDATE()),

('Oceanfront Penthouse', 'Penthouse', 3500000, N'Trống', N'Biệt thự trên không với view biển 360 độ, hồ bơi vô cực và rạp chiếu phim mini.', GETUTCDATE(), GETUTCDATE()),

('Deluxe Corner', 'Deluxe', 700000, N'Trống', N'Phòng góc với hai mặt kính, mang lại tầm nhìn thoáng đãng và không gian ngập tràn ánh sáng.', GETUTCDATE(), GETUTCDATE());
